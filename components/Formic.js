      ...
      >
        {({ touched, errors }) => (
          <Form className="text-base ">
            ...
            <p className="pb-1 text-sm text-[#00080DB2]">TEL:</p>
            <Field
              placeholder={formText.namePlaceholder}
              className={`${
                touched.tel && errors.tel ? "!border-[#EF4444]" : ""
              } ${inputStyles} ${inputHeight} mb-4`}
              name="tel"
            />
            <p className="pb-1 text-sm text-[#00080DB2]">CITTÀ:</p>
            <Field
              // placeholder={formText.messagePlaceholder}
              className={`${
                touched.message && errors.message ? "!border-[#EF4444]" : ""
              } ${inputStyles} ${inputHeight} mb-4`}
              name="message"
            />
            <Button
              ...
              className={`text-lg w-[15rem] !px-0 mt-6 ${btnClassname} ${colors.btnColor} ${BUTTON_STATES[sendingStatus]["state"]}`}
            >
